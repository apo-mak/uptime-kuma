export default {
    ...
    checkEverySecond: "Ελεγχος κάθε {0} δευτερόλεπτα",
    retryCheckEverySecond: "Προσπάθεια ξανά κάθε {0} δευτερόλεπτα",
    retriesDescription: "Μέγιστος αριθμός επαναλήψεων προτού η υπηρεσία επισημανθεί ως απενεργοποιημένη και σταλεί μια ειδοποίηση",
    ignoreTLSError: "Αγνοήστε το σφάλμα TLS/SSL για ιστότοπους HTTPS",
